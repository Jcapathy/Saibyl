          ...
          {projects.map((p, i) => (
            ...
            >
              <Link
                ...
                className="block bg-saibyl-deep rounded-2xl p-5 border border-white/[0.05] hover:border-saibyl-indigo/20 hover:bg-saibyl-elevated transition-all group"
              >
                ...
                <span className="font-mono text-[11px] text-saibyl-muted/60">{p.document_count ?? 0} documents</span>
              </Link>
            </motion.div>
          ))}
        </div>
