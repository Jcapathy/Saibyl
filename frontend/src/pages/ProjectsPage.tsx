...
import { Action, Card, Deal, Ground, Notice, PageHeader, Rise, cardSurface } from '@/components/design';
...
export default function ProjectsPage() {
  ...
  */
  ...
  return (
    <Ground className="p-6 min-h-full">
      <div className="max-w-5xl mx-auto">
        <Rise className="flex flex-wrap items-end justify-between gap-4 mb-6">
          <PageHeader
            eyebrow="Everything you uploaded"
            title="Your products"
            phrase="Everything Saibyl has read, filed under the thing it was written to sell."
          >
            <p>
