    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 bg-saibyl-gold text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#4B4FDE] hover:shadow-[0_0_20px_rgba(91,95,238,0.3)] transition-all"
        >
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <Link to="/app/simulations/new" className="bg-saibyl-gold text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-[#4B4FDE] transition">
            Create Simulation
          </Link>
        </div>
      ) : (
                  ...
                  >
                    <td className="px-5 py-3.5">
                      <Link
                        ...
                        className="font-medium text-saibyl-platinum hover:text-saibyl-gold transition-colors"
                      >
                        {sim.name}
                      </Link>
                      {sim.project_name && (
