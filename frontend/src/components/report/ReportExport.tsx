...
export default function ReportExport({ simulationId, simulationName, sections }: ReportExportProps) {
  ...
  return (
    <div className="flex gap-2">
      <button
        onClick={exportPDF}
        className="flex items-center gap-1.5 text-[12px] px-3 py-1.5 rounded-lg border border-saibyl-border-light text-saibyl-silver hover:text-saibyl-ink hover:border-saibyl-blue/40 transition-colors"
      >
